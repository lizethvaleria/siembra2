...
var resetValidationMessage = () => {
  if (sweetalert2_default.isVisible()) {
...
var handleDenyButtonClick = (instance, innerParams) => {
  instance.disableButtons();
...
var handleConfirmOrDenyWithInput = (instance, innerParams, type) => {
...
var handleInputValidator = (instance, innerParams, inputValue, type) => {
...
var deny = (instance, innerParams, value) => {
